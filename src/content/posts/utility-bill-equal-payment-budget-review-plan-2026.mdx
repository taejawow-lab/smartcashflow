...
|---|---|---|
| Treating equal payment as a discount | It usually changes timing, not total usage cost | Track actual usage and deferred balance |
| Ignoring rate notices | A flat payment can lag behind new rates | Recalculate after every rate or plan notice |
| Spending the seasonal surplus | The true-up month may need that cash | Keep a utility buffer category |
| Sharing full bills in help forums | Bills expose names, addresses, and account data | Redact identifiers before seeking advice |
